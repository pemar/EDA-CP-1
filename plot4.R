...
# plot the graph, save it ina PNG file, and terminate
par(mfrow=c(2,2), oma=c(0, 0, 0, 0))
plot(dt,data$Global_active_power,type="s",xlab="",ylab="Global Active Power")
plot(dt,data$Voltage,type="s",xlab="datetime",ylab="Voltage")
...
plot(dt,data$Global_reactive_power,type="s",xlab="datetime",ylab="Global_reactive_power")
